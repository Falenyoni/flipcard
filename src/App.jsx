...
function App() {
  const questions =[   
    {id: "1",
      question: "How would you design a fault-tolerant architecture on AWS?",
  ...
  return (
      ...
      <div className="App">
        {
          questions.map((q) => (
            <FlippableCard question ={q.question} answer={q.answer}/>
          ))
        }
